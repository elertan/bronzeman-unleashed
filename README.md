# ![icon](assets/bu-icon-medium.png) Bronzeman Unleashed
...
![unlock-overlay](assets/unlock-overlay.gif)

Every unlock gets celebrated.

![chatbox-unlocks](assets/chatbox-unlocks.png)
...
![drop-notification](assets/drop-notification.png)
